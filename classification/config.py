...
_C.MODEL.VSSM.EMBED_DIM = 96                         ############# you have to check the second config to tune this hyperparameter
...
_C.MODEL.VSSM.TOP_K = 4
_C.MODEL.VSSM.KNN = 5
_C.MODEL.VSSM.ALPHA = 100
_C.MODEL.VSSM.AMBIGUITY = False   
_C.MODEL.VSSM.BINARY = False
_C.MODEL.VSSM.K_GROUP = 8
_C.MODEL.VSSM.DIVISION_RATE = 4
_C.MODEL.VSSM.MODE = "RFN"
_C.MODEL.VSSM.DIMENSION = "INCREASE",
_C.MODEL.VSSM.CSMS6S_MODE = "NORMAL"
################################# one of these three
